...
echo "  python 01_function_calling_basics.py"
echo
echo "Model setup:"
echo "  OpenAI: export OPENAI_API_KEY=\"sk-...\""
echo "  Ollama: install Ollama, then run: ollama pull qwen2.5:7b"
echo "  Other OpenAI-compatible model: export OPENAI_BASE_URL, OPENAI_API_KEY, OPENAI_MODEL, OPENAI_API_MODE=chat_completions"
echo
